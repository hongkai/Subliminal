...
- (void)setUpTestCaseWithSelector:(SEL)testCaseSelector {
    ...
    if (testCaseSelector != @selector(testCanMatchComposeView)) {
        ...
        if (testCaseSelector == @selector(testCanReadToRecipients)) {
            messageInfo = @{ @"toRecipients": @[ @"foo@example.com" ] };
        } else if (testCaseSelector == @selector(testCanReadMultipleRecipients)) {
            messageInfo = @{ @"toRecipients": @[ @"foo@example.com", @"bar@example.com" ] };
        } else if (testCaseSelector == @selector(testCanReadCCRecipients)) {
            messageInfo = @{ @"ccRecipients": @[ @"foo@example.com" ] };
        } else if (testCaseSelector == @selector(testCanReadBCCRecipients)) {
            messageInfo = @{ @"bccRecipients": @[ @"foo@example.com" ] };
...
- (void)testCanReadBody {
    ...
    SLAssertTrue([actualBody isEqualToString:expectedBody],
